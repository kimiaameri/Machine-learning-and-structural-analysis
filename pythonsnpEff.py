    ...
    with open(inputFile) as csv_file:
        ...
        for row in csv_reader:
          if count !=0 :
            ...
            outFile.write(f'cat $WORK/SNP-outputs/snpEff/{row[0]}.ann.vcf | {minicondaBin}SnpSift.jar filter \ "(TYPE[*] has 'snp')"\ > $WORK/SNP-outputs/snpEff/filtered/{row[0]}.filtered.vcf \n')
